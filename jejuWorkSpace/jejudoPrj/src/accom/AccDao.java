...
public class AccDao {
	...
	public List<AccDto> accReservCheck(Connection conn) throws Exception {
		...
		String sql = "SELECT AR.ACCOM_NO, A.ACCOM_NAME, AR.RESERVE_DATE FROM ACCOM A JOIN ROOM R ON A.ACCOM_NO = R.ACCOM_NO JOIN ACCOM_RESERVATION AR ON AR.ROOM_NO = R.ROOM_NO WHERE CANCEL_YN = 'N' AND MEMBER_NO = ?";
