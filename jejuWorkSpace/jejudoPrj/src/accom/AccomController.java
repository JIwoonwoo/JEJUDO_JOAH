...
public class AccomController {
	...
	public void accReserve(AccDto dto) {
		System.out.println("선택하신 숙소를 예약 목록에 추가합니다.");
		...
		System.out.println("체크인 일자: " + dto.getCheckin() + "체크아웃일자: " + dto.getCheckout());

		int result = new AccService().accReserve(dto);
