...
public class FlightVo {
	...
	//매개변수 있는 생성자
	public FlightVo(String departure_date, String arrival_date, String flight_person, String dep_airport, String flight_price) {
		super();
	...
	public String toString() {
		return "FlightVo [departure_date=" + departure_date + ", arrival_date=" + arrival_date + ", flight_person="
