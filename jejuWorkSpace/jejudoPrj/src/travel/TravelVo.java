...
public class TravelVo {
	...
	// 생성자 (파라미터)
	public TravelVo(int trable_no, int recommend_type, int theme, int category, String travel_name,
			String travel_address, String activity_yn, int travel_price, String animal_yn, String travel_info,
			String travel_phone, String open, String closed, int like_cnt, String closed_day, Timestamp delete_date) {
		super();
