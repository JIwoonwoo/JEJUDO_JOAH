-- 제주도 전체 스크립트
--220804 추가 테이블 데이터, 관광지, 숙박, 렌트카 입력완료
...
-- 카페 추가
INSERT INTO TRAVEL VALUES(SEQ_TRAVEL.NEXTVAL, 6, 5, 4, '무로이', '제주 서귀포시 안덕면 동광본동로 21','N',7000,'Y','미술관에 온듯한 느낌의 카페','010-1412-0008','09:00','20:00',NULL,47,'N',NULL);
INSERT INTO TRAVEL VALUES(SEQ_TRAVEL.NEXTVAL, 7, 5, 4, '인스밀', '제주 서귀포시 대정읍 일과대수로27번길 22','N',6000,'Y','제주에서 외국느낌 물씬나는 이국적인 카페','010-1352-5661','11:30','18:30',NULL,74,'N',NULL);
INSERT INTO TRAVEL VALUES(SEQ_TRAVEL.NEXTVAL, 7, 5, 4, '오르다', '제주 서귀포시 성산읍 한도로 269-37','N',6500,'Y','천국의계단이 있는 뷰 맛집 카페','064-783-8368','09:00','23:30',NULL,56,'N',NULL);
INSERT INTO TRAVEL VALUES(SEQ_TRAVEL.NEXTVAL, 6, 5, 4, '오른', '제주 서귀포시 성산읍 해맞이해안로 2714','N',7000,'Y','노출콘크리트 건물의 인스타 감성 카페','010-1401-1559','10:30','20:00','2,4주 수요일',32,'N',NULL);
INSERT INTO TRAVEL VALUES(SEQ_TRAVEL.NEXTVAL, 7, 5, 4, '카페한라산', '제주 제주시 구좌읍 면수1길','N',6500,'N','세화해변 오션뷰 카페','064-783-1522','09:30','21:00',NULL,25,'N',NULL);
INSERT INTO TRAVEL VALUES(SEQ_TRAVEL.NEXTVAL, 7, 5, 4, '라라라', '제주 제주시 구좌읍 해맞이해안로 1430','N',6500,'Y','엽서에 세화해변 그리며 라라라','010-1328-0464','10:00','21:00',NULL,78,'N',NULL);
INSERT INTO TRAVEL VALUES(SEQ_TRAVEL.NEXTVAL, 6, 5, 4, '서귀피안 베이커리', '제주 서귀포시 성산읍 신양로122번길 17','N',6500,'N','파노라마 오션뷰 대형카페','010-1338-8378','08:00','21:00',NULL,53,'N',NULL);
INSERT INTO TRAVEL VALUES(SEQ_TRAVEL.NEXTVAL, 5, 5, 4, '랜딩커피', '제주 서귀포시 성산읍 신양로122번길 45-1','N',7500,'N','아무런 방해물 없이 오로지 바다를 감상','010-1387-0998','11:00','19:00',NULL,73,'N',NULL);
INSERT INTO TRAVEL VALUES(SEQ_TRAVEL.NEXTVAL, 6, 5, 4, '머문', '제주 제주시 구좌읍 해맞이해안로 460','N',8000,'N','월정리 최고의 탁트인 바다뷰와 넓은공간 맛있는 커피','070-7585-3519','10:00','20:30',NULL,26,'N',NULL);
INSERT INTO TRAVEL VALUES(SEQ_TRAVEL.NEXTVAL, 7, 5, 4, '우드스탁', '제주 제주시 구좌읍 월정7길 52','N',4500,'N','바다를 바라보며 멍때리기 좋은 카페','064-782-6948','09:00','24:00',NULL,72,'N',NULL);
INSERT INTO TRAVEL VALUES(SEQ_TRAVEL.NEXTVAL, 7, 5, 4, '클랭블루', '제주 제주시 한경면 한경해안로 552-22','N',8000,'N','커피와 문화를 제공하다','0507-1335-5338','11:00','20:00',NULL,39,'N',NULL);
INSERT INTO TRAVEL VALUES(SEQ_TRAVEL.NEXTVAL, 5, 5, 4, '유람위드북스', '제주 제주시 한경면 조수동2길 54-36','N',6000,'N','고양이와 책이 있는 북카페','070-4227-6640','11:00','22:00',NULL,38,'N',NULL);
INSERT INTO TRAVEL VALUES(SEQ_TRAVEL.NEXTVAL, 6, 5, 2, '모카다방', '제주 서귀포시 남원읍 태신해안로 125','N',7000,'N','독특한 방식의 옛날 모카라떼','0507-1492-8915','10:00','19:00','변동',58,'N',NULL);
...
-- 맛집 추가
INSERT INTO TRAVEL VALUES(SEQ_TRAVEL.NEXTVAL, 7, 5, 2, '떠돌이식객', '제주 서귀포시 성산읍 신고로22번길 37','N',15000,'Y','세상에서 단 하나뿐인 수제 해물라면','0507-1426-0508','09:00','22:00','화요일',36,'N',NULL);
INSERT INTO TRAVEL VALUES(SEQ_TRAVEL.NEXTVAL, 7, 5, 2, '가시아방국수', '제주 서귀포시 성산읍 고성리 528','N',8000,'N','성산유채꽃 보고 두툼한 돔베고기국수','064-783-0987','10:00','20:30','수요일',74,'N',NULL);
INSERT INTO TRAVEL VALUES(SEQ_TRAVEL.NEXTVAL, 7, 5, 2, '맛나식당', '제주 서귀포시 성산읍 동류암로 41','N',13000,'N','갈치조림이 맛있는 맛나식당','064-782-4771','08:00','21:00',NULL,36,'N',NULL);
INSERT INTO TRAVEL VALUES(SEQ_TRAVEL.NEXTVAL, 6, 5, 2, '산도롱맨도롱', '제주 제주시 구좌읍 해맞이해안로 2284','N',14000,'N','우도가 바라다 보이는 종달리 국수 맛집','064-782-5105','09:00','17:30','화요일',27,'N',NULL);
INSERT INTO TRAVEL VALUES(SEQ_TRAVEL.NEXTVAL, 5, 5, 2, '대수굴식당', '제주 제주시 구좌읍 대수길 10-4','N',19000,'N','가자 오래된 해녀문화를 간직한 식당','0507-1376-0829','10:00','22:00','화요일',84,'N',NULL);
INSERT INTO TRAVEL VALUES(SEQ_TRAVEL.NEXTVAL, 5, 5, 2, '어부피자', '제주 제주시 구좌읍 행원로5길 35-20 2층','N',62000,'N','프리미엄 피자위에 생생한 랍스타가 딱!','0507-1375-9242','11:00','21:00',NULL,36,'N',NULL);
INSERT INTO TRAVEL VALUES(SEQ_TRAVEL.NEXTVAL, 7, 5, 2, '대문집', '제주 제주시 한림읍 한림로 484','N',40000,'N','제주도 은갈치조림 맛집','064-796-3770','08:00','21:00','화요일',74,'N',NULL);
INSERT INTO TRAVEL VALUES(SEQ_TRAVEL.NEXTVAL, 6, 5, 2, '쪼끄뜨레', '제주 제주시 한경면 두신로 85 B동','N',15000,'N','신창 풍차 해안 수제돈가스 맛집','0507-1376-1025','11:00','18:00','월요일',53,'N',NULL);
INSERT INTO TRAVEL VALUES(SEQ_TRAVEL.NEXTVAL, 6, 5, 2, '체면', '제주 서귀포시 대정읍 단산로 95 1층 체면','N',11000,'N','송악산 근처 흑마농라멘 맛집','0507-1443-4422','11:30','21:00','월요일',74,'N',NULL);
INSERT INTO TRAVEL VALUES(SEQ_TRAVEL.NEXTVAL, 7, 5, 2, '미영이네식당', '제주 서귀포시 대정읍 하모항구로 42','N',55000,'N','모슬포항 앞에 위치한 방어회 고등어회','064-792-0077','11:30','22:00','수요일',37,'N',NULL);
INSERT INTO TRAVEL VALUES(SEQ_TRAVEL.NEXTVAL, 6, 5, 2, '네거리식당', '제주 서귀포시 서문로29번길 20','N',20000,'N','성게미역국, 갈치국을 만날 수 있는 식당','064-762-5513','07:00','21:40','비정기 휴무',46,'N',NULL);
