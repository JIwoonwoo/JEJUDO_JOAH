...
-- 220805 ver4 서연님의 관광지 백몇개 추가, 관광지 더 추가, 오류 모두 수정, 확인 완료, 문의사항 제목 VARCHAR(100)으로 변경, 문의작성 더미 추가
...
REM INSERTING into C##JEJU.MEMBER


Insert into C##JEJU.MEMBER (MEMBER_NO,ID,PWD,MEMBER_NAME,MEMBER_NICK,PHONE,EMAIL,ENROLL_DATE,QUIT_YN,POINT) values (SEQ_MEMBER.NEXTVAL,'swy352','4321','심원용','원드래곤','010-1234-5678','swy352@naver.com',to_timestamp('22/08/05 18:15:20.000000000','RR/MM/DD HH24:MI:SSXFF'),'N',656886);

REM INSERTING into C##JEJU.CAR_RESERVATION

Insert into C##JEJU.CAR_RESERVATION (CAR_NO,RENTAL_NO,MEMBER_NO,RENTAL_DATE,RETURN_DATE,RESERVE_DATE,INSURANCE,CANCEL_DATE,CANCEL_YN,PAID_YN) values (SEQ_CAR_RESERVATION.NEXTVAL,95,2,to_date('22/08/08','RR/MM/DD'),to_date('22/08/10','RR/MM/DD'),to_date('22/08/05','RR/MM/DD'),1,null,'N','Y');
Insert into C##JEJU.CAR_RESERVATION (CAR_NO,RENTAL_NO,MEMBER_NO,RENTAL_DATE,RETURN_DATE,RESERVE_DATE,INSURANCE,CANCEL_DATE,CANCEL_YN,PAID_YN) values (SEQ_CAR_RESERVATION.NEXTVAL,95,2,to_date('22/09/10','RR/MM/DD'),to_date('22/09/15','RR/MM/DD'),to_date('22/08/05','RR/MM/DD'),2,null,'N','Y');
Insert into C##JEJU.CAR_RESERVATION (CAR_NO,RENTAL_NO,MEMBER_NO,RENTAL_DATE,RETURN_DATE,RESERVE_DATE,INSURANCE,CANCEL_DATE,CANCEL_YN,PAID_YN) values (SEQ_CAR_RESERVATION.NEXTVAL,21,2,to_date('22/09/08','RR/MM/DD'),to_date('22/09/10','RR/MM/DD'),to_date('22/08/05','RR/MM/DD'),2,null,'N','Y');
Insert into C##JEJU.CAR_RESERVATION (CAR_NO,RENTAL_NO,MEMBER_NO,RENTAL_DATE,RETURN_DATE,RESERVE_DATE,INSURANCE,CANCEL_DATE,CANCEL_YN,PAID_YN) values (SEQ_CAR_RESERVATION.NEXTVAL,50,2,to_date('22/10/10','RR/MM/DD'),to_date('22/10/15','RR/MM/DD'),to_date('22/08/05','RR/MM/DD'),3,null,'N','Y');
Insert into C##JEJU.CAR_RESERVATION (CAR_NO,RENTAL_NO,MEMBER_NO,RENTAL_DATE,RETURN_DATE,RESERVE_DATE,INSURANCE,CANCEL_DATE,CANCEL_YN,PAID_YN) values (SEQ_CAR_RESERVATION.NEXTVAL,13,2,to_date('22/10/01','RR/MM/DD'),to_date('22/10/03','RR/MM/DD'),to_date('22/08/05','RR/MM/DD'),3,null,'N','Y');
Insert into C##JEJU.CAR_RESERVATION (CAR_NO,RENTAL_NO,MEMBER_NO,RENTAL_DATE,RETURN_DATE,RESERVE_DATE,INSURANCE,CANCEL_DATE,CANCEL_YN,PAID_YN) values (SEQ_CAR_RESERVATION.NEXTVAL,82,2,to_date('22/08/06','RR/MM/DD'),to_date('22/08/08','RR/MM/DD'),to_date('22/08/05','RR/MM/DD'),3,null,'N','Y');



REM INSERTING into C##JEJU.FLIGHT_RESERVATION
Insert into C##JEJU.FLIGHT_RESERVATION (FLIGHT_NO,DEPARTURE_FLIGHT,RETURN_FLIGHT,MEMBER_NO,RESERVE_DATE,CANCEL_YN,CANCEL_DATE,PAID_YN) values (SEQ_FLIGHT_RESERVATION.NEXTVAL,1031,1108,2,to_date('22/08/05','RR/MM/DD'),'N',null,'Y');
Insert into C##JEJU.FLIGHT_RESERVATION (FLIGHT_NO,DEPARTURE_FLIGHT,RETURN_FLIGHT,MEMBER_NO,RESERVE_DATE,CANCEL_YN,CANCEL_DATE,PAID_YN) values (SEQ_FLIGHT_RESERVATION.NEXTVAL,1724,1825,2,to_date('22/08/05','RR/MM/DD'),'N',null,'Y');
Insert into C##JEJU.FLIGHT_RESERVATION (FLIGHT_NO,DEPARTURE_FLIGHT,RETURN_FLIGHT,MEMBER_NO,RESERVE_DATE,CANCEL_YN,CANCEL_DATE,PAID_YN) values (SEQ_FLIGHT_RESERVATION.NEXTVAL,92,169,2,to_date('22/08/05','RR/MM/DD'),'N',null,'Y');
Insert into C##JEJU.FLIGHT_RESERVATION (FLIGHT_NO,DEPARTURE_FLIGHT,RETURN_FLIGHT,MEMBER_NO,RESERVE_DATE,CANCEL_YN,CANCEL_DATE,PAID_YN) values (SEQ_FLIGHT_RESERVATION.NEXTVAL,33,115,2,to_date('22/08/05','RR/MM/DD'),'N',null,'Y');
Insert into C##JEJU.FLIGHT_RESERVATION (FLIGHT_NO,DEPARTURE_FLIGHT,RETURN_FLIGHT,MEMBER_NO,RESERVE_DATE,CANCEL_YN,CANCEL_DATE,PAID_YN) values (SEQ_FLIGHT_RESERVATION.NEXTVAL,91,178,2,to_date('22/08/05','RR/MM/DD'),'N',null,'Y');
Insert into C##JEJU.FLIGHT_RESERVATION (FLIGHT_NO,DEPARTURE_FLIGHT,RETURN_FLIGHT,MEMBER_NO,RESERVE_DATE,CANCEL_YN,CANCEL_DATE,PAID_YN) values (SEQ_FLIGHT_RESERVATION.NEXTVAL,1087,1226,2,to_date('22/08/05','RR/MM/DD'),'N',null,'Y');
Insert into C##JEJU.FLIGHT_RESERVATION (FLIGHT_NO,DEPARTURE_FLIGHT,RETURN_FLIGHT,MEMBER_NO,RESERVE_DATE,CANCEL_YN,CANCEL_DATE,PAID_YN) values (SEQ_FLIGHT_RESERVATION.NEXTVAL,1987,2159,2,to_date('22/08/05','RR/MM/DD'),'N',null,'Y');

REM INSERTING into C##JEJU.ACCOM_RESERVATION
Insert into C##JEJU.ACCOM_RESERVATION (ACCOM_NO,ROOM_NO,MEMBER_NO,CHECK_IN,CHECK_OUT,RESERVE_DATE,CANCEL_YN,CANCEL_DATE,PAID_YN) values (SEQ_ACCOM_RESERVATION.NEXTVAL,42,2,to_timestamp('22/08/06 00:00:00.000000000','RR/MM/DD HH24:MI:SSXFF'),to_timestamp('22/08/08 00:00:00.000000000','RR/MM/DD HH24:MI:SSXFF'),to_timestamp('22/08/05 19:21:23.000000000','RR/MM/DD HH24:MI:SSXFF'),'N',null,'Y');
Insert into C##JEJU.ACCOM_RESERVATION (ACCOM_NO,ROOM_NO,MEMBER_NO,CHECK_IN,CHECK_OUT,RESERVE_DATE,CANCEL_YN,CANCEL_DATE,PAID_YN) values (SEQ_ACCOM_RESERVATION.NEXTVAL,34,2,to_timestamp('22/08/08 00:00:00.000000000','RR/MM/DD HH24:MI:SSXFF'),to_timestamp('22/08/10 00:00:00.000000000','RR/MM/DD HH24:MI:SSXFF'),to_timestamp('22/08/05 18:22:41.000000000','RR/MM/DD HH24:MI:SSXFF'),'N',null,'Y');
Insert into C##JEJU.ACCOM_RESERVATION (ACCOM_NO,ROOM_NO,MEMBER_NO,CHECK_IN,CHECK_OUT,RESERVE_DATE,CANCEL_YN,CANCEL_DATE,PAID_YN) values (SEQ_ACCOM_RESERVATION.NEXTVAL,32,2,to_timestamp('22/09/10 00:00:00.000000000','RR/MM/DD HH24:MI:SSXFF'),to_timestamp('22/09/15 00:00:00.000000000','RR/MM/DD HH24:MI:SSXFF'),to_timestamp('22/08/05 18:41:19.000000000','RR/MM/DD HH24:MI:SSXFF'),'N',null,'Y');
Insert into C##JEJU.ACCOM_RESERVATION (ACCOM_NO,ROOM_NO,MEMBER_NO,CHECK_IN,CHECK_OUT,RESERVE_DATE,CANCEL_YN,CANCEL_DATE,PAID_YN) values (SEQ_ACCOM_RESERVATION.NEXTVAL,39,2,to_timestamp('22/10/10 00:00:00.000000000','RR/MM/DD HH24:MI:SSXFF'),to_timestamp('22/10/15 00:00:00.000000000','RR/MM/DD HH24:MI:SSXFF'),to_timestamp('22/08/05 18:36:22.000000000','RR/MM/DD HH24:MI:SSXFF'),'N',null,'Y');
Insert into C##JEJU.ACCOM_RESERVATION (ACCOM_NO,ROOM_NO,MEMBER_NO,CHECK_IN,CHECK_OUT,RESERVE_DATE,CANCEL_YN,CANCEL_DATE,PAID_YN) values (SEQ_ACCOM_RESERVATION.NEXTVAL,8,2,to_timestamp('22/09/08 00:00:00.000000000','RR/MM/DD HH24:MI:SSXFF'),to_timestamp('22/09/10 00:00:00.000000000','RR/MM/DD HH24:MI:SSXFF'),to_timestamp('22/08/05 18:30:04.000000000','RR/MM/DD HH24:MI:SSXFF'),'N',null,'Y');
Insert into C##JEJU.ACCOM_RESERVATION (ACCOM_NO,ROOM_NO,MEMBER_NO,CHECK_IN,CHECK_OUT,RESERVE_DATE,CANCEL_YN,CANCEL_DATE,PAID_YN) values (SEQ_ACCOM_RESERVATION.NEXTVAL,32,2,to_timestamp('22/10/01 00:00:00.000000000','RR/MM/DD HH24:MI:SSXFF'),to_timestamp('22/10/03 00:00:00.000000000','RR/MM/DD HH24:MI:SSXFF'),to_timestamp('22/08/05 18:51:42.000000000','RR/MM/DD HH24:MI:SSXFF'),'N',null,'Y');
Insert into C##JEJU.ACCOM_RESERVATION (ACCOM_NO,ROOM_NO,MEMBER_NO,CHECK_IN,CHECK_OUT,RESERVE_DATE,CANCEL_YN,CANCEL_DATE,PAID_YN) values (SEQ_ACCOM_RESERVATION.NEXTVAL,21,2,to_timestamp('22/08/08 00:00:00.000000000','RR/MM/DD HH24:MI:SSXFF'),to_timestamp('22/08/10 00:00:00.000000000','RR/MM/DD HH24:MI:SSXFF'),to_timestamp('22/08/05 18:56:16.000000000','RR/MM/DD HH24:MI:SSXFF'),'N',null,'Y');

REM INSERTING into C##JEJU.QNA

Insert into C##JEJU.QNA (QUESTION_NO,MEMBER_NO,QUESTION_TITLE,QUESTION_TIME,ANSWER_YN,Q_CONTENT,A_CONTENT,MODIFY_TIME,DELETE_YN,DELETE_DATE,ANSWER_DATE) values (SEQ_QNA.NEXTVAL,2,'문의작성 테스트',to_timestamp('22/08/05 18:10:12.000000000','RR/MM/DD HH24:MI:SSXFF'),'N','문의 내역 작성중','답변 작성 완',to_timestamp('22/08/05 18:10:12.000000000','RR/MM/DD HH24:MI:SSXFF'),'N',null,null);
Insert into C##JEJU.QNA (QUESTION_NO,MEMBER_NO,QUESTION_TITLE,QUESTION_TIME,ANSWER_YN,Q_CONTENT,A_CONTENT,MODIFY_TIME,DELETE_YN,DELETE_DATE,ANSWER_DATE) values (SEQ_QNA.NEXTVAL,2,'렌터카 정보....',to_timestamp('22/08/05 19:05:37.000000000','RR/MM/DD HH24:MI:SSXFF'),'N','렌터카 정보가 뜨지않아요.... 정보 알고싶어여,,,,','죄송합니다. 서버 오류였습니다. 이제 되실거에용~~~',to_timestamp('22/08/05 19:05:37.000000000','RR/MM/DD HH24:MI:SSXFF'),'N',null,null);
Insert into C##JEJU.QNA (QUESTION_NO,MEMBER_NO,QUESTION_TITLE,QUESTION_TIME,ANSWER_YN,Q_CONTENT,A_CONTENT,MODIFY_TIME,DELETE_YN,DELETE_DATE,ANSWER_DATE) values (SEQ_QNA.NEXTVAL,2,'8282828282',to_timestamp('22/08/05 19:05:55.000000000','RR/MM/DD HH24:MI:SSXFF'),'N','빨리답변주세요','답변 빨리 완료 했어용,,,,',to_timestamp('22/08/05 19:05:55.000000000','RR/MM/DD HH24:MI:SSXFF'),'N',null,null);
Insert into C##JEJU.QNA (QUESTION_NO,MEMBER_NO,QUESTION_TITLE,QUESTION_TIME,ANSWER_YN,Q_CONTENT,A_CONTENT,MODIFY_TIME,DELETE_YN,DELETE_DATE,ANSWER_DATE) values (SEQ_QNA.NEXTVAL,2,'여행지들이 다 너무 비쌉니다.',to_timestamp('22/08/05 18:25:10.000000000','RR/MM/DD HH24:MI:SSXFF'),'N','왜 이렇게 비싼거죵 ㅠㅠㅠㅠㅠ','항상 노력하는 제주도좋아가 되겠습니다(기도이모티콘)',to_timestamp('22/08/05 18:25:10.000000000','RR/MM/DD HH24:MI:SSXFF'),'N',null,null);
