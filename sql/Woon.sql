...
-- 임시 멤버 추가
DELETE FROM MEMBER WHERE ID = 'WOON';
INSERT INTO MEMBER VALUES(73, 'WOON', 'KH3', 'WOON', 'WOON', NULL, NULL, DEFAULT, DEFAULT, 100000,NULL);
COMMIT;

-- 결제취소 셀렉트
SELECT P.PAY_NO,P.FLIGHT_NO,P.ACCOM_NO,P.CAR_NO
...
-- 취소 업데이트
UPDATE CAR_RESERVATION SET CANCEL_YN = 'Y' WHERE CAR_NO = 2;
UPDATE ACCOM_RESERVATION SET CANCEL_YN = 'Y' WHERE ACCOM_NO = 2;
UPDATE FLIGHT_RESERVATION SET CANCEL_YN = 'Y' WHERE FLIGHT_NO = 2;
UPDATE PAYMENT SET CANCEL_YN = 'Y' WHERE PAY_NO = 2;
